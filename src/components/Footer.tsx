...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-surface-950 text-white pt-16 pb-12 border-t border-zinc-800 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-8 border-b border-zinc-800">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-brand-400 hover:border-brand-500 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-emerald-400 hover:border-emerald-500 transition-colors"
                aria-label="WhatsApp"
              >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-zinc-400">
              ...
              <li><a href="#why-us" className="hover:text-white transition-colors">Why ClickShot</a></li>
            </ul>
          </div>
